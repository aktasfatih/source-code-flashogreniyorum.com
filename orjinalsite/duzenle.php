...
<title>Konu Düzenleme Bölümü - Flashogreniyorum.com</title>
</head>
...
<!-- Konular Bölümü -->
    ...
    <br />
    	<img src='../img/konu_duzenleme.gif' border='0' alt='Konu Düzenleme Bölümü - www.flashogreniyorum.com' />
    </td></tr>
    <tr><td align='center' valign='top'>
    	<?
			if(isset($_GET['konuno'])){
				$konuno=intval($_GET['konuno']);
				include('data.php');
				...
				$sorgu=mysql_query("SELECT * FROM flash_konular WHERE (id='".$konuno."')");
				if(!$sorgu){
				...
				echo "<br><table align='center' width='600' border='0'>";
				while($veri=mysql_fetch_array($sorgu)){
					echo "<form method='POST' action='konuduzenlendi.php'>";
					echo "<tr><td align='left'>Konu No:<input type='text' value='".$konuno."' name='konuno' readonly='readonly' style='border: none'></td></tr>";
					echo "<tr><td align='left'>Başlık:<br><input name='yb' type='text' value='".$veri['baslik']."'><br></tr></td>";
					echo "<tr><td align='center'><textarea rows='10' cols='80' name='yy'>".$veri['yazi']."</textarea></td></tr>";
					echo "<tr><td align='right'><input type='submit' value='Kaydet'></td></tr>";
