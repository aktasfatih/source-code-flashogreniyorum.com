...
<title>Arama yap / Sitenizi  Yapın - Flashogreniyorum.com</title>
</head>
...
<!-- Konular Bölümü -->
    ...
    <br />
    	<img src='../img/arama_bolumu.gif' border='0' alt='En son yazılan flash dersleri / konuları - flashogreniyorum.com' />
    </td></tr>
    <tr><td align='center' valign='top'>
    	<?
		if(!$_GET['arama']){
	echo "Arama kriteri yok.";	
}else{
$arama=$_GET['arama'];
...
$baglanti=@mysql_connect($host,$host_kullanici,$host_sifre);
	...
	$sorgu=mysql_query("SELECT * FROM flash_konular WHERE (baslik LIKE '$arama%')");
	
	if(mysql_num_rows($sorgu)>0){
		?>
        <br />
        <table align='center' border='1'>
        <tr><td>Konu No:</td><td width='600'>Başlık</td></tr>
        
        <?
		while($veri=mysql_fetch_array($sorgu)){
			echo "<tr><td>".$veri['id']."</td><td><A href='konu_oku.php?konuno=".$veri['id']."'>".$veri['baslik']."<A></tr>";
		}
		echo "</table>";
	}
}
