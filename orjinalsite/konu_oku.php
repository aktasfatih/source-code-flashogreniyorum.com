...
if($durum="girdi"){
		echo "<table height='25' width='1000' align='center' border='0' cellpadding='0' cellspacing='0' bgcolor='#C30D23' ><tr><td valign='middle' align='right'>";  
...
<!-- Konular Bölümü -->
	...
	$sorgu=mysql_query("SELECT * FROM flash_konular where id='".$_GET['konuno']."'");
	
	while($veri=mysql_fetch_array($sorgu)){
		
    print "<table width='700' height='25' border='0' cellpadding='0' cellspacing='0'>
    <tr><td height='30' align='center' background='../../img/Goruntudosyasi/baslik_arkaplan2.gif'>";
    		 echo $veri['baslik'];
    print "</td></tr>
   ...
   <br />";
				echo "<table align='center' width='600' ><tr><td style='word-wrap: break-word'><tr><td>";
				echo $veri['yazi'];
				echo "</td></tr></table>";
	}
     ?>
